			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">E-SchooL<span> Login</span></a>
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('login') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="login" class="form-control" id="login" placeholder="Email/Email/Phone">
                      </div>
                      <div class="mb-3">
